...
/**
 * A simple program that simulates a widget factory. Each widget takes a variable (random)
 * amount of time to make. The student should convert this program to be multithreaded and 
